...
### Committing that code lyfe
| Command | Description |
| ------- | ----------- |
| `git reset --soft HEAD~1` | Kill unpushed commit and keep code changes |
...
| `git push --set-upstream origin [branch name]` | Create a new branch in remote from new local branch|
